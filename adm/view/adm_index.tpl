...
<body>
      ...
      <div class="container position-relative">
        <div class="site-navigation text-center dark">
          ...
          <ul class="js-clone-nav pl-0 d-none d-lg-inline-block site-menu">
            <li class="active"><a href="{$GET_SITE_ADM}">Início</a></li>
            <li><a href="{$PAG_CATEGORIAS}">Categorias</a></li>
            <li><a href="{$PAG_ADM_PRODUTOS}">Produtos</a></li>
            <li><a href="{$PAG_ADM_CLIENTE}">Clientes</a></li>
            <li><a href="{$PAG_ADM_PEDIDOS}">Pedidos</a></li>
          </ul>
  ...
  <div class="owl-carousel owl-single home-slider" id="adm-image">
    <div class="item">
      <div class="untree_co-hero" id="adm-image" style="background-image: url('{$GET_TEMA}/images/adm-banner.jpg');">
        <div class="container">
