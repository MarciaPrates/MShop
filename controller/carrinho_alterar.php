...
/*
Se existir algum ID de produto <1 atraves do metodo post, quer dizer que há algum produto incorreto.
...
if (!isset($_POST['pro_id']) or $_POST['pro_id'] < 1) {
	...
	echo '<h4 class="alert alert-danger text-center"> Erro na operação! </h4>';
