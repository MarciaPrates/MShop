      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
            ...
            <img src="{$GET_TEMA}/images/hero_bg_6.jpg" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="team text-center">
            <div class="mb-4"><img src="{$GET_TEMA}/images/person_1.jpg" alt="Image" class="img-fluid"></div>
            <div class="team-body">
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="team text-center">
            <div class="mb-4"><img src="{$GET_TEMA}/images/person_2.jpg" alt="Image" class="img-fluid"></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="team text-center">
            <div class="mb-4"><img src="{$GET_TEMA}/images/person_3.jpg" alt="Image" class="img-fluid"></div>
            <div class="team-body">
