...
/images/cloth_1.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
          <div class="product-item">
            <a href="shop-single.html" class="product-img">
              ...
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/cloth_2.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
          <div class="product-item">
            <a href="shop-single.html" class="product-img">
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/watch_1.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
          ...
          <div class="product-item">
            <a href="shop-single.html" class="product-img">
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/shoe_2.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
          ...
          <div class="product-item">
            <a href="shop-single.html" class="product-img">
              <span class="custom-badge sale">Sale</span>
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/cloth_3.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
          ...
          <div class="product-item">
            <a href="shop-single.html" class="product-img">
              <span class="custom-badge sale">Sale</span>
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/shoe_1.jpg" alt="Image" class="img-fluid">
            </a>
  ...
  <div class="container">
    ...
    <div class="deal-hero" style="background-image: url('<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
