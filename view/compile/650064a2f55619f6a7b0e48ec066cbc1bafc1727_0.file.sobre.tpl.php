<?php
/* Smarty version 3.1.36, created on 2020-12-26 18:39:16
  from 'C:\xampp\htdocs\MShop\view\sobre.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5fe77544905b75_92859103',
...
function content_5fe77544905b75_92859103 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="untree_co-section">
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-5 mb-5">
          <h2 class="line-bottom mb-4" data-aos="fade-up" data-aos-delay="0">Porque nos escolher?</h2>
          ...
          <div class="row count-numbers mb-5">
            <div class="col-4 col-lg-4" data-aos="fade-up" data-aos-delay="0">
              ...
              <span class="caption-2">Vendas</span>
            </div>
            <div class="col-4 col-lg-4" data-aos="fade-up" data-aos-delay="100">
              ...
              <span class="caption-2">Clientes Felizes</span>
            </div>
            <div class="col-4 col-lg-4" data-aos="fade-up" data-aos-delay="100">
...
/images/hero_bg_6.jpg" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
          <h2 class="line-bottom text-center mb-4">Nosso Time</h2>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="team text-center">
            <div class="mb-4"><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/person_1.jpg" alt="Image" class="img-fluid"></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="team text-center">
            <div class="mb-4"><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/person_2.jpg" alt="Image" class="img-fluid"></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="team text-center">
            <div class="mb-4"><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/person_3.jpg" alt="Image" class="img-fluid"></div>
            <div class="team-body">
