        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text" style="padding-top:10px; padding-bottom:0px; padding-right:60px; padding-left:60px;">
              Olá {$NOME_CLIENTE}!<br>
              Obrigado por comprar na <b><a href="{$SITE_HOME}" style="text-decoration: none; color: black;"> M-Shop | Loja Virtual</a></b>.<br><br><br><br>
            </td>
          </tr>
          <tr>
            <td class="w320"  >
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                      <tr>
                        ...
                        <td class="product" valign="top" style="width:175px; text-align: left;">
                          <span style="color: #4d4d4d; font-weight:bold;">{$P.pro_nome}</span> <br>
                        </td>
                      </tr>
                    </table>
                  </td>
