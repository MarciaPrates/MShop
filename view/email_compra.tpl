              ...
              <tr>
                <td style="padding: 0 2.5em; text-align: left;">
                  <div class="text">
                    ...
                    <h3>Obrigado por comprar na <b><a href="{$SITE_HOME}" style="text-decoration: none; color: black;"> M-Shop | Loja Virtual</a></b>.</h3>
                  </div>
                </td>
              </tr>
            </table>
            ...
            <tr style="border-bottom: 2px solid rgba(0,0,0,.07);">
              ...
              <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                <div class="product-entry">
                  <img src="{$P.pro_img}" alt="{$P.pro_nome}" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                  <div class="text">
                    <h3>{$P.pro_nome}</h3>
                    <p>Qtd: {$P.pro_qtd}</p>
                  </div>
              ...
              <td valign="middle" width="30%" style="text-align:left; padding: 0 2.5em;">
                <span class="price" style="color: #000; font-size: 20px;">{$P.pro_valor}</span>
              </td>
              {/foreach}
            </tr>
          </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                        ...
                        <ul>
                          <li class="text btn btn-primary">R$ {$TOTAL}</li>
                        </ul>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                        ...
                        <ul>
                          <li><span class="text btn btn-primary">R$ {$FRETE}</span></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                        ...
                        <ul>
                          <li class="btn btn-primary"><b>R$ {$TOTAL_FRETE}</b></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
