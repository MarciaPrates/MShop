    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center pt-5">
          ...
          <h2 class="display-3 text-black">Página não encontrada!</h2>
          <p class="lead mb-5">Nos desculpe pelo transtorno.</p>
          <p><a href="index.html" class="btn btn-sm btn-outline-black">Voltar ao Início</a></p>
        </div>
      </div>
    </div>
  </div>
